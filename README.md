<!-- =========================================================
     KIRTIRAJ INGALE
     SOCIAL MEDIA • VIDEO • CREATIVE • AI
     ========================================================= -->
...
|   📱 SOCIAL MEDIA  | 🎬 VIDEO EDITING |    🎥 PRODUCTION   |         🤖 AI        |
| :----------------: | :--------------: | :----------------: | :------------------: |
|    Account Setup   |       Reels      |    Model Shoots    |     AI Workflows     |
|      Strategy      |      Shorts      | Testimonial Shoots |      AI Content      |
|  Content Planning  |   Brand Videos   |    Drone Shoots    |      AI Research     |
...
|                                   |                                                        |
| --------------------------------- | ------------------------------------------------------ |
| 🎬 **Professional Video Editing** | Clean, engaging and story-driven edits                 |
| 📱 **Social Media Reels**         | Fast-paced content optimized for short-form platforms  |
| ✨ **Motion Graphics**             | Visual elements that add movement and meaning          |
| 🔤 **Typography Style**           | Text-driven edits with strong visual rhythm            |
| 🎥 **Cinematic Editing**          | Color, pacing, sound design and cinematic storytelling |
| 📢 **Advertising Videos**         | Content designed around hooks, benefits and action     |
| ⭐ **Testimonial Videos**          | Editing real experiences into trust-building stories   |
| 🎞️ **B-Roll Editing**            | Supporting visuals that make the story more engaging   |
...
## **Have a business that needs better content?**
