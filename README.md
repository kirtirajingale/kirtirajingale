...
<p align="center"><i>I'm a passionate Full Stack Developer, capable of writing production-ready code using ReactJS, Redux, and CSS on the frontend, NodeJS, and Express on the backend to build a single application..</i></p>
